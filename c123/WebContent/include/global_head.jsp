...
<meta name="subject" content="서울장학재단 관리자모드" />
<meta name="title" content="서울장학재단 관리자모드페이지" />
<meta name="keywords" content="서울장학재단, 관리자모드" />
...
<link rel="stylesheet" type="text/css" href="<%=ConstantUtil.SERVER_HOST%>/js/tooltip/tooltip_style.css" />
<script type="text/javascript"  src="<%=ConstantUtil.SERVER_HOST%>/js/tooltip/tooltip_script.js"></script>
...
<script language="javascript" type="text/javascript"  src="<%=ConstantUtil.SERVER_HOST%>/webeditor/js/WebEditor.js"></script>
</head>