...
/*
	...
	// 2014.08.07 추가
	//conArrT["5년합계" 	]	= Array("5년합계"	, "60", "center",  "str", "ro");
...
*/	
  ...
  //gridT.attachHeader(["#rspan", "정렬","#rspan","#rspan","#rspan","#rspan","정렬","#rspan","#rspan","#rspan","#rspan","#rspan","#rspan","#rspan","#rspan","정렬","정렬","#rspan","#rspan","정렬"]);
  l_initGrid(gridT,idArrT,conArrT);	    
	...
	$(document).ready( function(){
      ...
      if (event.keyCode == '13') {
		...
		/*
		$("#sAmount", "#eAmount").keydown(function(event) {
  ...
  function onSelected(rowId,cellId){
    ...
    /*
		...
		//var openUrl = "/print/printContent2.20140405.jsp" + param;
		//l_viewPopup2(openUrl,'print', '890','850' );
  ...
  function fnDetail(rowId,cellId) {
	...
	function doSearch() {
        ...
        var params = "COMMAND=SEARCH";
            params += "&f2List="+encodeURIComponent(chkval);
